...
#include "auto_aim/msg/detail/gimbal_command__rosidl_typesupport_fastrtps_c.h"
...
using _GimbalCommand__ros_msg_type = auto_aim__msg__GimbalCommand;
...
size_t get_serialized_size_auto_aim__msg__GimbalCommand(
  const void * untyped_ros_message,
...
static uint32_t _GimbalCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_auto_aim__msg__GimbalCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_auto_aim
size_t max_serialized_size_auto_aim__msg__GimbalCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = auto_aim__msg__GimbalCommand;
    is_plain =
      (
...
static size_t _GimbalCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_auto_aim__msg__GimbalCommand(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, auto_aim, msg, GimbalCommand)() {
