...
static const _SerialData_type_support_symbol_names_t _SerialData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, auto_aim, msg, SerialData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, auto_aim, msg, SerialData)),
  }
};
...
{
  return &::auto_aim::msg::rosidl_typesupport_cpp::SerialData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, auto_aim, msg, SerialData)() {
  return get_message_type_support_handle<auto_aim::msg::SerialData>();
}
